...
with col2:
    st.image("D:/legalgpt/legalgpt/images/banner.png", use_column_width=True)
...
db = FAISS.load_local("D:/legalgpt/legalgpt/faiss_index", embeddings, allow_dangerous_deserialization=True)
